...
if ($obj->type == "food") {
     ...
     $query = "INSERT INTO order_food(order_id, order_number, price,order_datetime,number,status,food_id) VALUES(".$order_id.", 1, ".$obj->food_price.", '".$time."', ".$obj->number.", 1, ".$obj->food_id.");";
